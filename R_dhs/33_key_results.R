...
key_figures <- rbind(
  ...
  figure("figure36_age_specific_attributable.png",
         "attributable_fraction_by_age_band.png",
         "50_age_specific_attributable.R",
         paste("The main attributable-fraction result: share of all-cause",
               "mortality attributable to malaria against 0% prevalence as a",
               "function of MAP PfPR2-10, one panel per age band (<1, 1-3, 4-11,",
               "12-23, 24-35, 36-59 months), from the Stan fits of the",
               "person-time models; posterior mean and 95% credible interval;",
               "rug shows region-window prevalence.")),
  figure("figure32_person_time_burden_nga_cod.png",
         "burden_nigeria_drc_2005_2025.png",
         "48_person_time_burden_nga_cod.R",
         paste("Malaria-attributable under-5 deaths in Nigeria and DR Congo,",
               "2005-2025, from admin-1 MAP prevalence, the latest survey's",
               "regional and age shares of deaths and UN IGME all-cause death",
               "counts, with the Stan attributable fractions by age band;",
               "2025 carries 2024 inputs forward.")),
  figure("figure33_person_time_burden_ssa.png",
         "burden_sub_saharan_africa_vs_ihme.png",
         "49_person_time_burden_ssa.R",
         paste("Country estimates of malaria-attributable under-5 deaths in 2024",
               "against IHME/GBD, each country under the UN IGME and the IHME",
               "all-cause denominators, and the sub-Saharan total 2005-2025",
               "against IHME's own series.")),
  figure("figure34_allcause_igme_vs_ihme.png",
         "allcause_deaths_igme_vs_ihme.png",
         "49_person_time_burden_ssa.R",
         paste("The two all-cause denominators compared: UN IGME 2025 against",
               "IHME/GBD under-5 deaths by country in 2024, the ratio by age",
               "block, and the sub-Saharan totals by block over time.")),
  figure("figure35_burden_by_age_block_vs_ihme.png",
         "burden_by_age_block_vs_ihme.png",
         "49_person_time_burden_ssa.R",
         paste("Age composition of the 2024 malaria burden under both",
               "denominators against IHME's, and country estimates by age",
