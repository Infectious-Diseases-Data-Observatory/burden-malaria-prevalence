...
key_figures <- rbind(
  ...
  figure("figure31_person_time_joint_vs_separate.png",
         ...
         paste("Prevalence effect per 10 PfPR points by age band from the joint",
               "model with band-specific nuisance terms against the separate",
               "per-band fits; Wald test of equal slopes in the subtitle.")),
