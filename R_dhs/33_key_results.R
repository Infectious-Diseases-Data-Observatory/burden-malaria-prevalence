...
readme <- c(
  ...
  paste("The current analysis estimates the PfPR association with all-cause mortality",
        ...
        "The study-flow figure describes the current full-sample MAP gamma=2 primary analysis.",
        "Other figures document earlier survey-region and person-time analyses;",
