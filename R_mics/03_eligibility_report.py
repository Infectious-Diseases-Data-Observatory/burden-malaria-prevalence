...
md = ["# Can MICS surveys enter the primary analysis?", "",
 ...
 "`primary_map_regional17_dhsmics_gamma2_v5` alongside the 95 DHS surveys. That rule admits the six sub-national surveys "
 "with anthropometry (five Kenyan and Dakar city), whose wealth quintiles are ranked within their own sample. Guinea-Bissau and the "
 ...
 "- This assessment excluded sub-national MICS (five Kenyan county, province or settlement samples, Dakar city, southern Madagascar, two "
 "Somali zones) for consistency with the national-survey design. Their wealth quintiles are also ranked within the sub-national sample, "
 "not nationally, so that covariate would have to be rebuilt against a national reference. Nyanza 2011 was the strongest candidate. The "
 "rule later set for the primary admits those with anthropometry, with the within-sample ranking retained (see Outcome).",
 ...
 "already used, so they could enter that version. Somalia and South Sudan would need several years of national series extrapolated. "
 "The imputed-covariate version on the DHS and MICS sample (`primary_map_regional17_dhsmics_imputed_gamma2_v6`) now includes all "
 "of them, with the Somali and South Sudanese national series extrapolated by GAMs.",
