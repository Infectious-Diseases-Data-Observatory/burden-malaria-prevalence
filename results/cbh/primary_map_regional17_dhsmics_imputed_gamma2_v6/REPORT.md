...
The 17-covariate primary specification refitted after imputing every remaining covariate gap, so that all MAP-eligible DHS and MICS records are retained. Reference: the complete-case DHS+MICS primary `primary_map_regional17_dhsmics_gamma2_v5`. This version: `primary_map_regional17_dhsmics_imputed_gamma2_v6`. The DHS-only counterpart is `primary_map_regional17_imputed_gamma2_v4`.

## Sample

| Measure | Complete case (v5) | Imputed (v6) |
|---|---:|---:|
| Child-band records | 7,498,459 | 8,797,963 |
| Distinct children | 2,292,089 | 2,656,472 |
| Deaths |   102,282 |   123,419 |
| Survey-regions |     1,211 |     1,457 |
| Surveys |       132 |       166 |
| Countries |        36 |        40 |

Records whose values were imputed (point version): regional covariates 795,848; political stability 247,862 (2001 interpolation and South Sudan before independence); GDP 33,840 (South Sudan 2005–2007); health expenditure 260,385; child HIV incidence without an adolescent series 165,149. The extended HIV panel also changes censored and imputed incidence values in other countries, so the comparison mixes the covariate imputation with that panel change, as for v4 against v3.
...
| Age (months) | Complete-case covariates, DHS and MICS (v5) | Imputed covariates, DHS and MICS (v6) |
|---|---:|---:|
| <1 | 0.94 (0.92–0.97) | 0.94 (0.91–0.97) |
| 1-5 | 0.92 (0.88–0.95) | 0.91 (0.88–0.95) |
| 6-11 | 0.83 (0.79–0.87) | 0.82 (0.79–0.86) |
| 12-23 | 0.82 (0.77–0.88) | 0.84 (0.79–0.90) |
| 24-35 | 0.85 (0.80–0.91) | 0.86 (0.81–0.92) |
| 36-47 | 0.84 (0.78–0.91) | 0.86 (0.80–0.92) |
| 48-59 | 0.91 (0.83–0.99) | 0.95 (0.87–1.03) |

### PfPR 20% to 0%

| Age (months) | Complete-case covariates, DHS and MICS (v5) | Imputed covariates, DHS and MICS (v6) |
|---|---:|---:|
| <1 | 0.95 (0.90–1.00) | 0.93 (0.89–0.98) |
| 1-5 | 0.86 (0.81–0.93) | 0.87 (0.82–0.93) |
| 6-11 | 0.70 (0.63–0.77) | 0.69 (0.63–0.76) |
| 12-23 | 0.54 (0.48–0.62) | 0.55 (0.49–0.62) |
| 24-35 | 0.47 (0.41–0.54) | 0.47 (0.41–0.53) |
| 36-47 | 0.54 (0.47–0.63) | 0.55 (0.48–0.63) |
| 48-59 | 0.58 (0.49–0.68) | 0.58 (0.49–0.67) |

Largest absolute change in the 40% to 20% hazard ratio between v5 and v6: 0.040. Multiple-imputation check (10 imputed datasets, fixed smoothing parameters, Rubin's rules): largest change from the point fit 0.002; between-imputation share of variance at most 2.3% ([report](multiple_imputation/REPORT.md)).

## Fits

All seven fits converged with full rank, finite coefficients and covariances and positive smoothing-Hessian eigenvalues; 0 used the tighter-tolerance restart. Fitted model columns were checked against the input rows. Total fitting time 17 minutes.
