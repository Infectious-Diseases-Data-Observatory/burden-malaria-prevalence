...
Seven separate MAP gamma=2 age-band models refitted in four subsets of the fitted 17-variable sample (`primary_map_regional17_dhsmics_gamma2_v5`). Reference: the full primary fits in `results/cbh/primary_map_regional17_dhsmics_gamma2_v5`.
...
- Surveys up to median year: 1,076,607 children, 3,399,915 records, 55,805 deaths, 549 survey-regions, 70 surveys, 33 countries
- Surveys after median year: 1,215,482 children, 4,098,544 records, 46,477 deaths, 662 survey-regions, 62 surveys, 34 countries
...
|---|---:|---:|---:|---:|---:|
| <1 | 0.94 (0.92–0.97) | 0.90 (0.85–0.96) | 1.00 (0.96–1.04) | 0.94 (0.91–0.97) | 0.94 (0.90–0.98) |
| 1-5 | 0.92 (0.88–0.95) | 0.91 (0.84–0.99) | 0.90 (0.84–0.96) | 0.90 (0.86–0.95) | 0.92 (0.87–0.98) |
| 6-11 | 0.83 (0.79–0.87) | 0.73 (0.66–0.81) | 0.85 (0.80–0.91) | 0.82 (0.78–0.86) | 0.87 (0.81–0.93) |
| 12-23 | 0.82 (0.77–0.88) | 0.70 (0.65–0.76) | 0.81 (0.74–0.89) | 0.80 (0.74–0.85) | 0.83 (0.76–0.90) |
| 24-35 | 0.85 (0.80–0.91) | 0.73 (0.67–0.81) | 0.84 (0.77–0.93) | 0.84 (0.78–0.90) | 0.80 (0.73–0.87) |
| 36-47 | 0.84 (0.78–0.91) | 0.78 (0.69–0.89) | 0.95 (0.86–1.06) | 0.87 (0.80–0.95) | 0.81 (0.72–0.91) |
| 48-59 | 0.91 (0.83–0.99) | 0.74 (0.64–0.85) | 0.88 (0.76–1.01) | 0.87 (0.79–0.96) | 0.93 (0.81–1.06) |

## Validation

All 28 subgroup fits converged with full rank, finite coefficients and covariances and positive smoothing-Hessian eigenvalues; 3 needed the tighter-tolerance restart (see restarts.csv where present). Fitted model columns were checked against the selected input rows; curves are anchored at zero at 20% PfPR. Total pure fitting time 591 seconds.
