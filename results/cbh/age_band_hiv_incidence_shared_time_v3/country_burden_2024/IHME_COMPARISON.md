# Model versus IHME malaria mortality, 2024

The comparison matches 42 countries on ISO3, 2024, both sexes and under-five age. The x-axis uses IHME **malaria** deaths, not IHME all-cause deaths. All 42 matched counts are positive and appear on both the linear and logarithmic panels.
...
|---|---:|---:|---:|
| Democratic Republic of the Congo | 45,859 | 61,774 | 0.74 |
| Nigeria | 157,264 | 138,111 | 1.14 |

Across the same 42 countries, our point estimates sum to 433,510 deaths versus 428,147 for IHME (ratio 1.01).
...
[Comparison data](model_vs_ihme_malaria_2024.csv)
