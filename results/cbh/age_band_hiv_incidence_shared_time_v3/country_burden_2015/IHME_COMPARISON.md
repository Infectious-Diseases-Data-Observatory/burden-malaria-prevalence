# Model versus IHME malaria mortality, 2015

The comparison matches 42 countries on ISO3, 2015, both sexes and under-five age. The x-axis uses IHME **malaria** deaths, not IHME all-cause deaths. All 42 matched counts are positive and appear on both the linear and logarithmic panels.
...
|---|---:|---:|---:|
| Democratic Republic of the Congo | 57,043 | 72,887 | 0.78 |
| Nigeria | 193,762 | 131,749 | 1.47 |

Across the same 42 countries, our point estimates sum to 509,214 deaths versus 416,122 for IHME (ratio 1.22).
...
![Scatter comparison](model_vs_ihme_malaria_2015.png)

![Every matched country](model_vs_ihme_malaria_by_country_2015.png)

[Comparison data](model_vs_ihme_malaria_2015.csv)
