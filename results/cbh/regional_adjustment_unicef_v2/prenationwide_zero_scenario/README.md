# Missingness under the pre-nationwide zero scenario
...
|---|---:|---:|---:|---:|
| previous_primary | 1,217,838 | 20.69% | 47 | 28 |
| eligible_MAP | 1,628,672 | 25.62% | 68 | 31 |
...
Reproduce: `Rscript R_cbh/covariates/10_prenationwide_zero_scenario.R`.
