...
| Figure 4: countries (A), Nigerian states (B) and annual trend (C) versus IHME/UN IGME, deaths per 1,000 child-years | [Combined figure](../results/cbh/primary_map_regional17_gamma2_v3/burden_comparison/fig4_burden_comparison.png) and [caption](../results/cbh/primary_map_regional17_gamma2_v3/burden_comparison/CAPTION.md) |
