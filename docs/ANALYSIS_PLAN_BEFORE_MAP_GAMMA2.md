> **Archived on 10 September 2026.** This is the plan before MAP with gamma=2 was selected as primary. It contains superseded specifications. Use [the current analysis plan](ANALYSIS_PLAN.md) for active decisions.
