...
The primary CBH builder, HIV model, seven MAP gamma=2 fits, Snow supplementary workflows, input bridges and their shared helpers remain active. Historical CBH fitting/burden code with still-needed data/model-frame dependencies was deliberately retained and is documented in [the audit](../../docs/CODE_AUDIT.md).
