...
- `results/cbh/age_band_hiv_incidence_v2/`: mortality fit using median child incidence, sample accounting, contrasts and curves.
- `results/cbh/age_band_hiv_incidence_v2/multiple_imputation/`: conditional-fit diagnostics and pooled contrasts/curves.
