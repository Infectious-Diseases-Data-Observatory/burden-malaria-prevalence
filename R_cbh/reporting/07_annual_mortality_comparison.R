...
sources <- c(model = model_label, ihme_malaria = "IHME", who_cacode = "WHO/UNICEF (CA-CODE)")
...
writeLines(c("# Figure 5: annual under-five malaria mortality", "",
  ...
  paste0("| Year | ", model_label, " deaths | Rate | IHME deaths | Rate | WHO/UNICEF deaths | Rate |"),
  "|---|---:|---:|---:|---:|---:|---:|", rows, "",
