...
writeLines(c("# Key results — primary MAP analysis","",
  ...
  paste("| Age-band results table |",link("Table","tables/age_band_results.md"),"and",link("LaTeX fragment","tables/age_band_results.tex"),"|"),
  ...
  paste("| Figure 4: comparison with IHME |",link("Scatter plots","burden/country_vs_ihme.png"),"|"),
  paste("| Figure 5: annual mortality, 2004–2024 |",link("Figure","annual_comparison/fig5_annual_malaria_mortality.png"),"and",link("totals and input audit","annual_comparison/README.md"),"|"),
