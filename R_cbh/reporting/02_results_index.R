...
writeLines(c("# Key results — primary MAP analysis","",
  ...
  paste("| Figure 4: countries (A), Nigerian states (B) and annual trend (C) versus IHME/UN IGME |",link("Combined figure","burden_comparison/fig4_burden_comparison.png"),"and",link("caption","burden_comparison/CAPTION.md"),"|"),
  ...
  paste("| Figure 4C source: annual mortality, 2004–2024 |",link("Figure","annual_comparison/fig5_annual_malaria_mortality.png"),"and",link("totals and input audit","annual_comparison/README.md"),"|"),
