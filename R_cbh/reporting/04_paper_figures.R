...
# Figure 4 combines the former Figures 4 (2024 panel), 6 and 5 as panels A, B and C.
figures <- data.frame(figure=1:4,
  filename=c("fig1_survey_map_and_timing.png","fig2_pfpr_mortality_by_age.png",
    "fig3_malaria_attributable_fraction_by_age.png","fig4_burden_comparison.png"),
